...
float triangle_heron_area(struct triangle * tri)
{
    return heron_area_formula(
            distance(tri->polygon.vertex[0], tri->polygon.vertex[1]),
            distance(tri->polygon.vertex[1], tri->polygon.vertex[2]),
            distance(tri->polygon.vertex[2], tri->polygon.vertex[0]));
}


float triangle_shoelace_area(struct triangle *tri)
{
    return shoelace_area_formula(tri->polygon.vertex[0], tri->polygon.vertex[1], tri->polygon.vertex[2]);
}
...
float triangle_height_from_base1(struct triangle *tri)
{
    return 2 * triangle_area(tri) / distance(tri->polygon.vertex[0], tri->polygon.vertex[1]);
}

float triangle_height_from_base2(struct triangle *tri)
{
    return 2 * triangle_area(tri) / distance(tri->polygon.vertex[1], tri->polygon.vertex[2]);
}

float triangle_height_from_base3(struct triangle *tri)
{
    return 2 * triangle_area(tri) / distance(tri->polygon.vertex[2], tri->polygon.vertex[0]);
}
