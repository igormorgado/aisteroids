...
void                 gameobjnode__add_after(struct gameobjnode * self, struct gameobjnode * node);
void                 gameobjnode__add_before(struct gameobjnode * self, struct gameobjnode * node);
struct gameobjnode * gameobjnode__add_gameobj_after(struct gameobjnode * self, struct gameobj * node);
struct gameobjnode * gameobjnode__add_gameobj_before(struct gameobjnode * self, struct gameobj * node);
